...
using MITD.Presentation.UI.DateTimePicker.ViewModels;
...
namespace MITD.Presentation.UI.DateTimePicker.Views
{
    ...
    public partial class PCalendar 
    {
        ...
        void setSelectedGDate(DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.NewValue == null)
            {
                SelectedPersianDate = @"____/__/__";
                return;
            }
            eDate = e.NewValue.ToString();
        ...
        {
            string pDate = null;
            if ((e.NewValue == null) || ((string)(e.NewValue) == @"____/__/__"))
            {
                pDate = PDateHelper.GregorianToHijri(DateTime.Now, false);
                if (SelectedDate != null) SelectedDate = null;
            }
            else
            {
                pDate = e.NewValue.ToString();
            }
