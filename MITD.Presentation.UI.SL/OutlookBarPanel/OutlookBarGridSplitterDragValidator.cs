...
//This code is from the Silverlight toolkit Gridsplitter DragValidator
...
namespace MITD.Presentation.UI
{
    ...
    internal class OutlookBarGridSplitterDragValidator
    {
        ...
        /// </param>
        public OutlookBarGridSplitterDragValidator(UIElement targetElement)
        {
