...
using MITD.Presentation.UI.DateTimePicker.Brushes;
using MITD.Presentation.UI.DateTimePicker.Models;
using MITD.Presentation;
using MITD.Core;

namespace MITD.Presentation.UI.DateTimePicker.ViewModels
{
    /// <summary>
